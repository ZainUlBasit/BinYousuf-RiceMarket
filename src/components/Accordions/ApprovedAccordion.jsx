...
const AccordionItem = ({ name, location, content, orderNo, OrderData }) => {
        ...
        <div className="flex items-center justify-end gap-x-3">
          <div className=" px-2 py-2 flex gap-x-2 items-center">
            <div className="flex gap-x-1">
              <div className="text-[#999FA6]">Order No:</div>
              <div>{orderNo}</div>
            </div>
          ...
          {content.map((cn, index) => (
            ...
            >
              ...
              <div className="font-bold text-sm">
                {" "}
                Rs {Number(cn.quantity) * Number(cn.price)}
              </div>
            </div>
          ))}
